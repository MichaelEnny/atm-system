...
if __name__ == "__main__":
    ...
    # Test case with account 666666
    card6_retry = Card("666666", "7777")
    assert atm.insert_card(card6_retry)
    assert atm.enter_pin("7777")

    print("\n--- Test Case 13 ---")
    print("Balance (a6):", atm.check_balance())                # 2500.0 (from previous operations)
    print("Deposit:", atm.deposit(1500))                       # -> Deposit
    print("Balance (a6):", atm.check_balance())                # 4000.0
    print("Withdraw:", atm.withdraw(500))                      # -> Withdrawal
    print("Balance (a6):", atm.check_balance())                # 3500.0
    print("Transfer to a5:", atm.transfer("555555", 1000))     # -> Transfer
    print("Balance (a6):", atm.check_balance())                # 2500.0
    print("Balance (a5):", a5.balance)                         # 2500.0
    print("Deposit again:", atm.deposit(300))                  # -> Deposit
    print("Balance (a6):", atm.check_balance())                # 2800.0

    atm.eject()

    # Test case with account 777777
    card7_retry = Card("777777", "3333")
    assert atm.insert_card(card7_retry)
    assert atm.enter_pin("3333")

    print("\n--- Test Case 14 ---")
    print("Balance (a7):", atm.check_balance())                # 3100.0 (from previous operations)
    print("Withdraw:", atm.withdraw(800))                      # -> Withdrawal
    print("Balance (a7):", atm.check_balance())                # 2300.0
    print("Deposit:", atm.deposit(1700))                       # -> Deposit
    print("Balance (a7):", atm.check_balance())                # 4000.0
    print("Transfer to a4:", atm.transfer("444444", 1200))     # -> Transfer
    print("Balance (a7):", atm.check_balance())                # 2800.0
    print("Balance (a4):", a4.balance)                         # 3450.0
    print("Withdraw again:", atm.withdraw(300))                # -> Withdrawal
    print("Balance (a7):", atm.check_balance())                # 2500.0

    atm.eject()

    # Test case with account 888888
    card8_retry = Card("888888", "2222")
    assert atm.insert_card(card8_retry)
    assert atm.enter_pin("2222")

    print("\n--- Test Case 15 ---")
    print("Balance (a8):", atm.check_balance())                # 4750.0 (from previous operations)
    print("Deposit:", atm.deposit(2250))                       # -> Deposit
    print("Balance (a8):", atm.check_balance())                # 7000.0
    print("Withdraw:", atm.withdraw(1500))                     # -> Withdrawal
    print("Balance (a8):", atm.check_balance())                # 5500.0
    print("Transfer to a2:", atm.transfer("222222", 1000))     # -> Transfer
    print("Balance (a8):", atm.check_balance())                # 4500.0
    print("Balance (a2):", a2.balance)                         # 3300.0
    print("Deposit again:", atm.deposit(500))                  # -> Deposit
    print("Balance (a8):", atm.check_balance())                # 5000.0

    atm.eject()

    # Test case with account 333333
    card1_retry = Card("333333", "1234")
    assert atm.insert_card(card1_retry)
    assert atm.enter_pin("1234")

    print("\n--- Test Case 16 ---")
    print("Balance (a1):", atm.check_balance())                # 2800.0 (from previous operations)
    print("Withdraw:", atm.withdraw(800))                      # -> Withdrawal
    print("Balance (a1):", atm.check_balance())                # 2000.0
    print("Deposit:", atm.deposit(1000))                       # -> Deposit
    print("Balance (a1):", atm.check_balance())                # 3000.0
    print("Transfer to a3:", atm.transfer("111111", 500))      # -> Transfer
    print("Balance (a1):", atm.check_balance())                # 2500.0
    print("Balance (a3):", a3.balance)                         # 2000.0
    print("Withdraw again:", atm.withdraw(300))                # -> Withdrawal
    print("Balance (a1):", atm.check_balance())                # 2200.0
